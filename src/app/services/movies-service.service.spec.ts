...
describe('MoviesServiceService', () => {
  ...
  it('should get all data', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiURL}/movie/550?api_key=${environment.API_KEY}`);
  ...
  it('should get all trending movies', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiURL}/trending/all/day?api_key=${environment.API_KEY}`);
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  });
  ...
  it('should get all fiction movies', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiURL}/discover/movie?api_key=${environment.API_KEY}&with_genres=878`);
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  });
  ...
  it('should get all action movies', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiURL}/discover/movie?api_key=${environment.API_KEY}&with_genres=27`);
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  });
